...
AUTH_USER_MODEL = 'farmapp.farmuser'
...
SECRET_KEY = 'django-insecure-@e^o_69b7z^j4n&g32l40h#q9b^8b!l$04p5b11!o&p*gq#d&y'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'rest_framework.permissions.AllowAny', # Allow access by default, set specific permissions on views
    )
}
